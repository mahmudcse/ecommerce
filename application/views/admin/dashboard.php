		...
		<div class="col-md-6 chart-layer1-right"> 
			...
			<div class="malorm-bottom">
				...
				<ul class="malorum-icons">
					<li><a href="<?php echo base_url(); ?>assets/admin/#"><i class="fa fa-facebook"> </i>
						<div class="tooltip"><span>Facebook</span></div>
					</a></li>
					<li><a href="<?php echo base_url(); ?>assets/admin/#"><i class="fa fa-twitter"> </i>
						<div class="tooltip"><span>Twitter</span></div>
					</a></li>
					<li><a href="<?php echo base_url(); ?>assets/admin/#"><i class="fa fa-google-plus"> </i>
...
<div class="chart-layer-2">
	...
	<div class="col-md-6 chart-layer2-right">
	        ...
	        <div class='bar_group'>
				...
				<script src="<?php echo base_url(); ?>assets/admin/js/bars.js"></script>
